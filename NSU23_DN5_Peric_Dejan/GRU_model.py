...
def normiraj(sez, glavni_sez):
    ...
    return (sez - glavni_sez.mean())/max(glavni_sez.std(), 0.3)

def odnormiraj(sez, glavni_sez):
    return max(glavni_sez.std(), 0.3)*sez + glavni_sez.mean()
